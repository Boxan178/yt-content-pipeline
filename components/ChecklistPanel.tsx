    ...
    <section className="glass rounded-3xl p-4">
      <header className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 text-[10px]">
          <span className="nums rounded-full border border-yellow-500/40 bg-yellow-500/10 px-2 py-0.5 font-medium text-yellow-300">
            {sortedPending.length} pendientes
          </span>
          <span className="nums rounded-full border border-green-500/40 bg-green-500/10 px-2 py-0.5 font-medium text-green-300">
            {done.length} hechos
          </span>
          {order && order.length > 0 && (
            <button
              onClick={() => persistOrder([])}
              className="rounded-full border border-white/10 bg-white/5 px-2 py-0.5 text-zinc-400 transition hover:bg-white/10 hover:text-white"
      ...
      {sortedPending.length === 0 ? (
        <div className="flex items-center justify-center gap-2 rounded-2xl border border-green-500/30 bg-green-500/5 px-3 py-3 text-xs text-green-300">
      ...
      {done.length > 0 && (
        <details className="mt-3">
          <summary className="cursor-pointer text-[10px] font-medium uppercase tracking-label text-zinc-500 transition hover:text-zinc-300">
